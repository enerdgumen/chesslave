...
public class RulesTest {
    ...
    public void whitePawnMoves() {
        final Position position = Position.of(
                ...
                " | |P| | | | | ",
                " | | | |K| | | ");
        final Set<Square> got = Rules.targets(position, Square.of("c2"));
    ...
    public void blackPawnMoves() {
        final Position position = Position.of(
                ...
                " | | | | | | | ",
                " | | | |K| | | ");
        final Set<Square> got = Rules.targets(position, Square.of("c7"));
    ...
    public void lockedPawn() {
        final Position position = Position.of(
                ...
                " | | | | | | | ",
                " | | | |K| | | ");
        final Set<Square> got = Rules.targets(position, Square.of("c4"));
    ...
    public void whiteEnPassant() {
        final Position position = Position.of(
                ...
                " | | | | | | | ",
                " | | | |K| | | ");
        final Set<Square> got = Rules.targets(position, Square.of("d5"));
    ...
    public void kingMoves() {
        final Position position = Position.of(
                ...
                " | | | | | | | ",
                " | | | | | | | ");
        final Set<Square> got = Rules.targets(position, Square.of("e4"));
    ...
    public void kingCannotMoveOutOfTheBoard() {
        final Position position = Position.of(
                ...
                " | | | | | | | ",
                " | | | | | | | ");
        final Set<Square> got = Rules.targets(position, Square.of("e8"));
